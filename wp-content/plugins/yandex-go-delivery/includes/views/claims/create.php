...
wp_enqueue_script( YGO_PLUGIN_ID . '-create-claim-js', YGO_PLUGIN_URL . '/assets/js/create-claim.js', [ 'jquery' ], $version, false );
wp_localize_script( YGO_PLUGIN_ID . '-create-claim-js', 'yandexSettings', [
...
<form method='POST' id="yandex-taxi-delivery_claim_form" class="yandex-taxi-delivery_form"
		...
		<div class="yandex-taxi-delivery_form__route_point yandex-taxi-delivery_setting_form__group"
				...
				<div class="yandex-taxi-delivery_form__column_left">
					<div class="yandex-taxi-delivery_map__group">
						<div class="yandex-taxi-delivery_form__group js_yandex-taxi-delivery_param_container">
							<label for="warehouse_address"><?php echo __( 'Адрес', 'yandex-go-delivery' ); ?> *</label>
					...
					<div class="yandex-taxi-delivery_form__group row">
						<div class="yandex-taxi-delivery_form__group_small">
							...
							<label for="warehouse_flat"><?php echo __( 'Квартира', 'yandex-go-delivery' ); ?></label>
						...
						<div class="yandex-taxi-delivery_form__group_small">
							<label for="warehouse_porch"><?php echo __( 'Подъезд', 'yandex-go-delivery' ); ?></label>
							<input class="js_yandex-taxi-delivery_form__param"
							       id="warehouse_porch"
							       name="warehouse[porch]"
							       type="text"
							       value="<?php echo _wp_specialchars( $warehouse->getPorch() ); ?>">
						</div>

						<div class="yandex-taxi-delivery_form__group_small">
							<label for="warehouse_floor"><?php echo __( 'Этаж', 'yandex-go-delivery' ); ?></label>
							<input class="js_yandex-taxi-delivery_form__param"
							       id="warehouse_floor"
					...
					<div class="yandex-taxi-delivery_form__group">
						<label for="warehouse_comment"><?php echo __( 'Комментарий', 'yandex-go-delivery' ); ?></label>
						<textarea
								class="yandex-taxi-delivery_form__group__input__textarea js_yandex-taxi-delivery_form__param"
								id="warehouse_comment"
								name="warehouse[comment]"><?php echo empty( $warehouse->getComment() ) ? $warehouseCommentPlaceholder : _wp_specialchars( $warehouse->getComment() ); ?></textarea>
					</div>
				</div>
			...
			<div class="yandex-taxi-delivery_form__row">
				<div class="yandex-taxi-delivery_form__column_left">
					...
					<div class="yandex-taxi-delivery_form__group js_yandex-taxi-delivery_param_container">
						<label for="warehouse_name"><?php echo __( 'Имя', 'yandex-go-delivery' ); ?> *</label>
					...
					<div class="yandex-taxi-delivery_form__group row">
						<div class="yandex-taxi-delivery_form__group_small js_yandex-taxi-delivery_param_container">
							<label for="warehouse_phone"><?php echo __( 'Номер телефона', 'yandex-go-delivery' ); ?>
								*</label>
							<input class="yandex-taxi-delivery_form__group__input js_yandex-taxi-delivery_form__param"
							       type="tel"
							       id="warehouse_phone"
					...
					<div class="yandex-taxi-delivery_form__group checkbox">
						<input id="due_is_on" type="checkbox" name="warehouse[due][is_on]">
						<label for="due_is_on"><?php echo __( 'Забрать заказ в конкретное время', 'yandex-go-delivery' ); ?></label>
					</div>
					...
					<div class="yandex-taxi-delivery_form__group">
						...
						<div class="yandex-taxi-delivery_form__datetime">
							...
							<input type="number" class="minute js_yandex-taxi-delivery_form__param"
							       ...
							       name="warehouse[due][minute]" min="0" max="59" step="1"
					...
					<div class="yandex-taxi-delivery_form__group checkbox">
						<input class="js_yandex-taxi-delivery_form__param"
						       id="warehouse_sms_on"
						       type="checkbox"
						       name="warehouse[sms_on]">
						<label for="warehouse_sms_on"><?php echo __( 'Включить SMS подтверждение', 'yandex-go-delivery' ); ?></label>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="yandex-taxi-delivery_settings_grid">
		<div class="yandex-taxi-delivery_form__container_actions yandex-taxi-delivery_setting_form__group">
			<h3><?php echo __( 'Новая точка в маршруте', 'yandex-go-delivery' ); ?></h3>
			<div class="yandex-taxi-delivery_form__group row start">
				<label for="add_order_id"><?php echo __( 'Добавить заказ №', 'yandex-go-delivery' ); ?></label>
				<input id="add_order_id" type="number" name="add_order_id">
				<a class="button"
				   id="yandex-taxi-add-point"><?php echo __( 'Добавить заказ', 'yandex-go-delivery' ); ?></a>
			</div>
			<div class="yandex-taxi-delivery_form__group row start">
				<a class="button"
				   id="yandex-taxi-add-fake-point"><?php echo __( 'Добавить без заказа', 'yandex-go-delivery' ); ?></a>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function ($) {
		$('input[name*="warehouse[due][date]"], .datepicker').datepicker({
			dateFormat: "yy-mm-dd",
			minDate: 0,
		});
