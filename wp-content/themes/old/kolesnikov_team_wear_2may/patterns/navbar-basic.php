...
<!-- wp:group -->
<div class="headerMain" style="color: #fff;">

    <!-- wp:pattern {"slug":"ktsportwear/topnavbar-basic"} /-->

    <!-- wp:group -->
    <div class="headerMainNav wp-block">
        <!-- wp:group -->
        <div class="headerMainNavWrap gridWrap wp-block-group"
                ...
                <div class="mobileMenuOverlay"
                    ...
                    <div class="mobileMenuContent"
                                ...
                                <div class="mobileMenuContentHeaderRow">
                                    <div class="mobileMenuContentHeaderLt">
                                        <div class="mobileMenuContentHeaderLtWrapper"
                                            ...
                                            <!-- Здесь меню -->
                                            <div @click="SparkVibe.setValueByPath('appMenu.mobBurger.show', false)"
                                                 style="cursor:pointer;">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M8.82223 10L2.32812 3.5059L3.50663 2.32739L10.0007 8.82143L16.4948 2.32739L17.6733 3.5059L11.1792 10L17.6733 16.494L16.4948 17.6726L10.0007 11.1785L3.50663 17.6726L2.32812 16.494L8.82223 10Z"
                                                          fill="#F9F9F9"/>
                                                </svg>
                                            </div>
                        ...
                        <div class="mobileMenuContentHeaderSubHeader"
                             style="margin-bottom: 30px; color: rgba(249,249,249,0.5)">
                            <div class="headerSubHeaderTitle"
                                 style="font-family: 'Montserrat',sans-serif;font-weight: 600;font-size: 12px;line-height: 125%;letter-spacing: 0;">
                                Меню
                            </div>
                        </div>

                        <div class="mobileMenuContentMenu" style="margin-bottom: 30px;">
            ...
            <div class="headerMainNavLt" style="display: flex; align-items: center; gap: 45px;">
                <!-- wp:group -->
                <div class="headerMainNavMenuMob" @click="SparkVibe.setValueByPath('appMenu.mobBurger.show', true)">
                    <div class="navMenuMobIcon" style="display: flex">
                        <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.5 3.33301H24.5V4.99967H3.5V3.33301ZM3.5 9.16634H24.5V10.833H3.5V9.16634ZM3.5 14.9997H24.5V16.6663H3.5V14.9997Z"
                                  fill="#F9F9F9"/>
                        </svg>
                    </div>
                </div>

                <div class="headerMainNavLogo"
                     style="">
            ...
            <div class="headerMainNavItem wp-block">
                <a href="/cart">
                    <div class="headerMainNavItemWrap" style="position: relative;">
                        <?php $wc_cart = WC()->cart;
                        if (count($wc_cart->get_cart())) { ?>
                            <div class="headerMainNavItemBadge">
                                <?php echo count($wc_cart->get_cart()) ?>
                            </div>
                        <?php } ?>
                        <div class="headerMainNavItemIcon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
