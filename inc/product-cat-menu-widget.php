...
//        echo $args['before_title'] . '<a href="' . $link . '">' . apply_filters('widget_title', $title) . '</a>' . $args['after_title'];
        ...
        echo "<div class='widgetMenuHeading'><a href='" . $instance['link'] . "'><div class='widgetMenuHeadingWrapper'><span class='widgetTitle'>" . $instance['title'] . "</span><span class='widgetIcon'><img src='" . get_template_directory_uri() . '/assets/images/menu-arrow.svg' . "'></div></a></div>";
...
//        echo $args['before_title'] . '<a href="' . $link . '">' . apply_filters('widget_title', $title) . '</a>' . $args['after_title'];
        ...
        if (!empty($categories)) {
            ...
            echo '<li>';
            echo '<a href="' . $instance['link'] . '">Смотреть все</a>';
            echo '</li>';
...
//                }
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['parent_id'] = (!empty($new_instance['parent_id'])) ? $new_instance['parent_id'] : null;
        return $instance;
    }
}
