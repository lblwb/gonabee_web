<div id="appMainFilter">
    <div class="appFilterWrapper">
        ...
        <div class="filter-section">
            ...
            <div v-if="expandedSections && expandedSections.includes('subcategory')" class="filter-content" style="margin-bottom: 20px">
                <label class="filter-item" v-for="subCatItem in filterData.subcategories" style="text-decoration: none">
                    <input type="hidden" v-model="selectedSubcategory" :value="subCatItem.slug" @change="applyFilters"/>
                    <span class="subCatItem">
        ...
        <div class="filter-section">
            ...
            <div v-if="expandedSections && expandedSections.includes('price')" class="filter-content">
                <div class="sliderRange">
                    <svg width="343" height="15" viewBox="0 0 343 15" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%;">
                        <line x1="343" y1="8.5" y2="8.5" stroke="#DCDCDC"/>
                        <line x1="318" y1="8.5" x2="25" y2="8.5" stroke="#F0C224"/>
                        <circle cx="17.5" cy="7.5" r="7.5" fill="#F0C224"/>
                        <circle cx="325.5" cy="7.5" r="7.5" fill="#F0C224"/>
                    </svg>
                </div>
                <div class="sliderWrapper" style="display: flex; justify-content: space-between; align-items: center;gap: 18px; ">
                    <div class="sliderRangeInput" style="display: flex; gap: 10px;align-items: center;">
                        <label for="">От</label>
                        <input type="number" v-model="filterData.minPrice" style="padding: 10px 18px; width: 100%; border-radius: 5px; border: solid 1px #1F1F1F10;" />
                    </div>
                    <div class="sliderRangeInput" style="display: flex; gap: 10px;align-items: center;">
                        <label for="">До</label>
                        <input type="number" v-model="filterData.maxPrice" style="padding: 10px 18px; width: 100%; border-radius: 5px; border: solid 1px #1F1F1F10;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Размер -->
        <div class="filter-section" v-if="sizes">
            ...
            <div v-if="expandedSections.includes('sizes')" class="filter-content">
                <label v-for="size in sizes" :key="size" class="filter-item">
                    <input type="radio" v-model="selectedSize" :value="size" @change="applyFilters"/>
                    <span>{{ size }}</span>
                </label>
            </div>
        </div>
        ...
        <div class="filter-section" v-if="filterData && filterData.colors">
            ...
            <div v-if="expandedSections.includes('colors')" class="filter-content" style="margin-bottom: 20px">
                <label v-for="color in filterData.colors" :key="color.name" class="filter-item color-item">
                    <input type="checkbox" v-model="selectedColors" :value="color.name" @change="applyFilters"/>
        ...
        <div class="filter-section">
            <div class="filter-content">
                <label class="filter-item" @click="toggleSection('onSale')"
                    ...
                    <input type="hidden" v-model="onSale" @change="applyFilters"/>
                </label>
            </div>
        </div>
        <div class="filter-section">
