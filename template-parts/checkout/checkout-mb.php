<div class="cartMbWrapper" id="appMbCheckout" v-cloak>
        ...
        <div class="cartPageBody">
            ...
            <form ref="checkoutForm" name="checkout" method="post" class="checkout woocommerce-checkout"
                ...
                <div class="cartPageBodyWrapper">
                    <div class="cartPageBodyList" v-if="appStateCheckout.step.selected === 'userinfo'">
                        <!--   WC()->cart->get_cart()-->
                    ...
                    <div class="cartPageBodyList" v-if="appStateCheckout.step.selected === 'delivery'">
                    ...
                    <div class="cartPageBodyList" v-if="appStateCheckout.step.selected === 'payment'">
                        <!-- Блок: Способ оплаты -->
                        ...
                        <div class="cartMobBottomBlockSpr" style="opacity: 0.2; padding: 20px 0;">
                            <hr>
                        </div>
                                                            ...
                                                            <div class="bodyListItemProductInfoCard">
                                                                <div class="bodyListItemProductInfoCardTop"
                                                                    ...
                                                                    <div class="infoCardTopWhlBtn"
                                                                        ...
                                                                        <div class="infoCardTopWhlBtnIcon" v-else>
                                                                            <svg width="30" height="30"
                                                                                viewBox="0 0 30 30" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <rect width="30" height="30" rx="15"
                                                                ...
                                                                <?php $thumb_url = wp_get_attachment_image_url($main_image_id, 'original'); ?>
                            ...
                            <section class="order-block">
                                ...
                                <div class="order-detail">
                                    <div class="order-detail__item">
                                        <strong class="label">ФИО</strong>
                                        <div class="value">{{ appStateCheckout.totalData.customerInfo.name }}</div>
                                    </div>
                                    <div class="order-detail__item">
                                        <strong class="label">Номер телефона</strong>
                                        <div class="value">{{ appStateCheckout.totalData.customerInfo.phone }}</div>
                                    </div>
                                    <div class="order-detail__item">
                                        <strong class="label">Email</strong>
                                        <div class="value">{{ appStateCheckout.totalData.customerInfo.email }}</div>
                                    </div>
                                </div>
                            </section>
                                        ...
                                        <div class="promocodeWrapper">
                                            ...
                                            <div class="promocodeBlock" role="region" aria-label="Promocode Section">
                                                ...
                                                <div class="promocodeBlock__content" id="promocodeContent" v-show="appPromocodeStates.isOpen" role="group" :aria-hidden="!appPromocodeStates.isOpen">
                                                    <input v-model.trim="appPromocodeStates.promocode" type="text" placeholder="Промокод или сертификат" @keyup.enter="applyPromocode" :disabled="appPromocodeStates.isLoading" aria-label="Введите промокод или сертификат" class="promocodeBlock__input" />
                                                    <button @click="applyPromocode" :disabled="!appPromocodeStates.promocode || appPromocodeStates.isLoading" :aria-busy="appPromocodeStates.isLoading" class="promocodeBlock__applyButton"><span v-if="appPromocodeStates.isLoading" class="promocodeBlock__loadingSpinner"></span><span v-else>Применить</span></button>
                                                    <p v-if="appPromocodeStates.message" class="promocodeBlock__message" :class="{ 'promocodeBlock__messageError': appPromocodeStates.isError }">{{ appPromocodeStates.message }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
