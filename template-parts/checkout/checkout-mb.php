<div class="cartMbWrapper"
    id="appMbCheckout"
    v-cloak
    data-ajax_url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>"
    data-nonce="<?php echo esc_attr(wp_create_nonce('coupon')); ?>">
    <div class="cartMbHeader" style="background: #222222;">
        <div class="cartMbHeaderWrapper"
            style="display: flex; justify-content: space-between; align-items: center; padding: 18px;">
            <div class="cartMbHeaderBtn" @click="backBtn">
            ...
            <div class="cartMbHeaderBtn">
            </div>
        </div>
    </div>
    <div class="cartPageWrapper gridWrap"
        v-if="appStateCheckout.isMobile"
        style="position: relative;overflow-y: auto; overflow-x: hidden; max-height: 80vh;">
        <div class="cartPageHeading">
            <div class="cartPageHeadingTitle">
                <h1>{{appStateCheckout.appTitle}}</h1>
            </div>
        </div>

        <div class="cartPageBody">
            <!--            {{appStateCheckout.step.selected}}-->
            <form ref="checkoutForm" name="checkout" method="post" class="checkout woocommerce-checkout"
                action="<?php echo esc_url(wc_get_checkout_url()); ?>" enctype="multipart/form-data"
                aria-label="<?php echo esc_attr__('Checkout', 'woocommerce'); ?>">
                <div class="cartPageBodyWrapper">
                    <div class="cartPageBodyList" :class="{__Selected: appStateCheckout.step.selected === 'userinfo'}" v-show="appStateCheckout.step.selected === 'userinfo'">
                        <!--   WC()->cart->get_cart()-->
                        ...
                        <div ref="billingFieldsWrapper">
                            <?php do_action('woocommerce_checkout_billing'); ?>
                        </div>


                        <div class="footerMbFixed" style="position: fixed; bottom: 0; right: 0; left: 0; z-index: 100">
                            <div class="footerMbFixedBlock" style="padding: 10px;">
                                <div class="footerMbFixedBlockBtn" @click="selectStepCheckout('delivery')"
                                    style="background: #F0C224; border-radius: 100px; padding: 12px 24px; text-align: center;">
                                    <div class="blockBtnHeading">
                                        <div class="blockBtnHeadingTitle"
                            ...
                            <div class="footerMbFixedEmpty" style="min-height: 30px;">
                            </div>
                        </div>

                    </div>
                    <div class="cartPageBodyList" :class="{__Selected: appStateCheckout.step.selected === 'delivery'}" v-show="appStateCheckout.step.selected === 'delivery'">
                        ...
                        <div class="footerMbFixed" style="position: fixed; bottom: 0; right: 0; left: 0; z-index: 100">
                            <div class="footerMbFixedBlock" style="padding: 10px;">
                                <div class="footerMbFixedBlockBtn" @click="selectStepCheckout('payment')"
                                    style="background: #F0C224; border-radius: 100px; padding: 12px 24px; text-align: center;">
                                    <div class="blockBtnHeadingTitle"
                                        style="font-family: 'Montserrat',sans-serif;font-weight: 600;font-size: 14px;line-height: 125%;letter-spacing: 0%;text-align: center;">
                    ...
                    <div class="cartPageBodyList" :class="{__Selected: appStateCheckout.step.selected === 'payment'}" v-show="appStateCheckout.step.selected === 'payment'">
                        <!-- Блок: Способ оплаты -->
                                                            ...
                                                            <div class="bodyListItemProductInfoCard">
                                                                <div class="bodyListItemProductInfoCardTop"
                                                                    ...
                                                                    <div class="infoCardTopWhlBtn"
                                                                        ...
                                                                        <div class="infoCardTopWhlBtnIcon" :class="{disable: getSelectedWhtLst(<?= esc_attr($product->get_id()); ?>)}">
                        ...
                        <div class="customerData">
                            ...
                            <!-- Блок: Получатель заказа -->
                            <section class="order-block">
                                <header class="order-block__title"
                                    style="font-family: 'Sofia Sans',sans-serif; font-weight: 500; font-size: 20px; line-height: 125%; letter-spacing: 0%;">
                                    <span>Получатель заказа</span>
                                    <a href="#" @click.prevent="selectStepCheckout('userinfo')" class="edit-link"
                                        style="color: #F0C224;">Изменить</a>
                                </header>

                                <div class="order-detail">
                                    <div class="order-detail__item"
                                        v-for="({label, value}, key) in userInfo"
                                        :key="key">
                            ...
                            <section class="order-block">
                                <header class="order-block__title"
                                    ...
                                    <a href="#" @click.prevent="selectStepCheckout('delivery')" class="edit-link">Изменить</a>
                                </header>

                                <div class="order-detail"
                                    v-if="formData.shipMethodId">
                                    <div class="order-detail__item">
                                        <!--                                        <strong class="label">Метод</strong>-->
                                        <div class="paymentMethodIBoxWrapper icon" style="margin-bottom: 10px;">
                                            <!-- CDEK -->
                                            <svg v-if="formData.shipMethodId.includes('official_cdek')" width="42" height="12" viewBox="0 0 42 12" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M6.44533 9.08714H4.61639C1.76326 9.08714 3.83606 2.90042 6.23806 2.90042H9.12779C9.5911 2.90042 10.408 2.98757 10.8104 1.81743L11.4322 0H7.46953C5.3236 0 3.65315 0.771785 2.44606 2.06639C0.36107 4.28215 -0.346118 7.74274 0.153792 9.39835C0.629316 10.9295 1.92177 11.9378 3.94578 11.9627L5.51868 11.9751H7.45734L7.93288 10.5187C8.28646 9.48549 7.49393 9.08714 6.44533 9.08714ZM28.7096 6.52281L29.307 4.54358H22.9302C21.8694 4.54358 21.3938 4.84233 21.211 5.46472L20.6135 7.44399H26.9904C28.0512 7.44399 28.5267 7.14523 28.7096 6.52281ZM19.6625 10.0083L19.065 11.9875H25.4419C26.4905 11.9875 26.9782 11.6888 27.1611 11.0664L27.7586 9.08714H21.3817C20.3331 9.08714 19.8575 9.38589 19.6625 10.0083ZM30.1971 1.9917L30.7947 0.012448H24.4177C23.3569 0.012448 22.8814 0.311203 22.6985 0.93361L22.1011 2.91287H28.478C29.5267 2.91287 30.002 2.61411 30.1971 1.9917ZM20.5648 2.39004C20.2965 0.547719 19.3332 0.012448 16.9922 0.012448H12.7247L10.2373 7.44399H11.8102C12.7491 7.44399 13.2246 7.45644 13.7245 6.08713L14.7609 2.90042H16.346C17.6994 2.90042 17.3946 4.63072 16.7118 6.3112C16.1021 7.79252 15.0413 9.09959 13.7611 9.09959H11.1152C10.0544 9.09959 9.56674 9.39835 9.37163 10.0208L8.71321 12H10.6519L12.554 11.9875C14.2366 11.9751 15.6144 11.8506 17.2239 10.3693C18.9309 8.78838 20.9061 4.73028 20.5648 2.39004ZM42 0H38.3056L34.8305 3.77178C34.428 4.20746 34.0135 4.64314 33.611 5.15354H33.5745L35.3058 0H32.2944L28.2341 11.9875H31.2458L32.5381 8.21578L33.8793 7.05809L34.9402 10.4689C35.2693 11.527 35.6109 11.9875 36.3425 11.9875H38.6469L36.2814 5.29046L42 0Z"
                                                    fill="#00B33C" />
                                            </svg>

                                            <!-- YANDEX -->
                                            <svg v-else-if="formData.shipMethodId.includes('yandex-go-delivery')" width="30" height="32" viewBox="0 0 30 32" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <img v-else width="35px" src="<?= get_template_directory_uri() ?>/assets/images/logo.png" alt="">
                                        </div>

                                        <div class="value">{{ appStateCheckout.totalData.deliveryInfo.method }}</div>
                                    </div>
                                    <div class="order-detail__item">
                                        <strong class="label">Телефон</strong>
                                        <div class="value">{{ appStateCheckout.totalData.deliveryInfo.phone }}</div>
                                    </div>
                                    <div class="order-detail__item" v-if="formData.shipMethodId.includes('pickup_location')">
                                        <strong class="label">График</strong>
                                        <div class="value">{{ appStateCheckout.totalData.deliveryInfo.schedule }}</div>
                                    </div>
                                    <!-- <div class="order-detail__item">
                                        <strong class="label">Сроки</strong>
                                        <div class="value">{{ appStateCheckout.totalData.deliveryInfo.term }}</div>
                                    </div> -->
                                    <div class="order-detail__item" v-if="!formData.shipMethodId.includes('pickup_location')">
                                        <strong class="label">Стоимость</strong>
                                        <div class="value">{{ appStateCheckout.totalData.deliveryInfo.cost }}</div>
                                    </div>
                                </div>
                        ...
                        <div class="cartPageBodySide">
                            <div class="cartPageBodySideCheckoutBlock">
                                <div class="checkoutBlockHeading">
                                    <div class="checkoutBlockHeadingTitle" style="">Ваш заказ</div>
                                </div>
                                <div class="checkoutBlockBody">
                                    ...
                                    <div class="checkoutBlockBodyRow">
                                        <div class="checkoutBlockBodyRowWrap">
                                            ...
                                            <div class="checkoutBlockBodyRowItem">0 <span class="woocommerce-Price-currencySymbol">₽</span></div>
                                        </div>
                                    </div>
                                    <div class="checkoutBlockBodyRow">
                                        <div class="checkoutBlockBodyRowWrap">
                                            <div class="checkoutBlockBodyRowItem" style="font-weight: 600;">Итоговая
                                                сумма:
                                            </div>
                            ...
                            <div class="checkoutBlockFooter">
                                ...
                                <p class="delivery-note">Доставку и способ оплаты можно выбрать при оформлении
                                    заказа</p>
                            </div>
                        </div>
                        ...
                        <div class="footerMbFixed" style="position: fixed; bottom: 0; right: 0; left: 0; z-index: 100">
                            <div class="footerMbFixedBlock" style="padding: 10px;">
                                <button class="footerMbFixedBlockBtn" type="submit"
                                    style="background: #F0C224; border-radius: 100px; padding: 12px 24px; text-align: center; border: none; width: 100%;">
                                    <div class="blockBtnHeadingTitle"
                                        style="font-family: 'Montserrat',sans-serif;font-weight: 600;font-size: 14px;line-height: 125%;letter-spacing: 0%;text-align: center;">
                                        Оплатить заказ
                                    </div>
