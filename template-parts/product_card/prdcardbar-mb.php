...
<!-- mob -->
<div class="shopProductDetailMobFixBar" id="singlePrdMob" data-is-stock="<?= $product->is_in_stock() ? 'true' : 'false' ?>" data-product-id="<?php echo esc_attr($product_id); ?>"
    v-cloak
            ...
            <div class="detailMobFixBarSelectActionsWrap" style="">
                ...
                <div class="addToCartBtn" style=""
                    ...
                    <div class="addToCartBtnWrapper" style="">
                        <div class="addToCartBtnTitle" style="">
                            <?php if ($product->is_in_stock()): ?>
                                <!-- Тоже через {{ … }} -->
                                Добавить в корзину <?php echo $product->get_price_html(); ?>
                            <?php else: ?>
