                                                ...
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <?php if ($idea_images): ?>
                                                        <?php foreach ($idea_images as $image): ?>
                                                            <div class="sliderBlockItemImages swiper-slide" <?php try {?> onclick="window.states.singlePrdCard.showIdeaByProduct('<?php echo $related_product[0]->ID;  ?>')<?php }catch(Exception $e){} ?>">
