...
?>
<div class="mobileNav">
    <a href="/account/helper/" class="mobileNav__item <?= nav_is_active('account/helper/') ?>">
    ...
    <a href="/account/reviews/" class="mobileNav__item <?= nav_is_active('account/reviews/') ?>">
        <div class="mobileNav__wrapper">
            <div class="mobileNav__icon">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="/public_offer/" class="mobileNav__item <?= nav_is_active('public_offer/') ?>">
        <div class="mobileNav__wrapper">
